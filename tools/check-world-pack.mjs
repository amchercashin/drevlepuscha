...
assert.equal(Object.keys(manifest.tiles).length,7040);assert.ok(size('dist')<250*1048576,'Published size budget');const map=JSON.parse(gunzipSync(readFileSync(root+manifest.map)));assert.equal(map.pois.length,15);assert.equal(map.zones.length,9);
