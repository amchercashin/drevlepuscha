...
def prepare(source, guide):
    ...
    bpy.context.view_layer.objects.active=meshes[0];bpy.ops.object.join();mesh=bpy.context.object;mesh.name='WoodlandBird'
    ...
    for material in mesh.data.materials:
        material.name='WoodlandBird_atlas';material.use_backface_culling=False
