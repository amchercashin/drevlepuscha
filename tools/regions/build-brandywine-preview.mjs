...
json('data/build-inputs.json', Object.fromEntries([sourcePath, 'src/domain/regions/authoring-core.mjs', 'tools/regions/authoring-core.mjs', 'tools/regions/terrain-review.mjs', 'tools/regions/build-brandywine-preview.mjs'].map(p => [p, hash(readFileSync(resolve(root, p)))])));
...
s+=text(64,88,'План региона · 4 × 4 км · метры EN · рельеф 0.1.2', 'font-size="19"');
