...
export type PackedFloor={positions:Float32Array;indices:Uint32Array;colors:Float32Array;uvs:Float32Array;heights:Float32Array;normals:Float32Array;wind:Float32Array};
...
function pack(g:FloorGeometry):PackedFloor{
 ...
 return {wind:new Float32Array(g.wind),positions:new Float32Array(g.positions),indices:new Uint32Array(g.indices),colors:new Float32Array(g.colors),uvs:new Float32Array(g.uvs),heights:new Float32Array(g.heights),normals:new Float32Array(normals)};
}
self.onmessage=({data})=>{
 ...
 try{
  ...
  if(data.layer){
   ...
   const geometry={wind:new Float32Array(g.wind),positions:new Float32Array(g.positions),indices:new Uint32Array(g.indices),normals:new Float32Array(g.normals),colors:new Float32Array(g.colors),uvs:new Float32Array(g.uvs)};
