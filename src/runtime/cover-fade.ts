...
export class CoverFade extends MaterialPluginBase {
 ...
 constructor(material:Material,private start:number,private end:number,private wind=false){super(material,'CoverFade',220,{COVER_FADE:true},true,false);this._enable(true);}
 ...
 override getCustomCode(type: string):Record<string,string>|null{
  ...
  return {CUSTOM_FRAGMENT_DEFINITIONS:this.wind?'varying vWindRestW: vec3f;':'',CUSTOM_FRAGMENT_MAIN_BEGIN:`
