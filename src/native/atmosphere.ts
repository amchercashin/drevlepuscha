...
export function createNativeAtmosphere(){
 let totalHours=12,hours=12,automatic=true,baseFog=.011,rays=true,moon=moonSettings();
 ...
 <label><input id="day-rays" type="checkbox" checked> Художественные лучи</label>
