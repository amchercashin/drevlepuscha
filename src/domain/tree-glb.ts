...
export function treeGLB(parts:TreePart[],textures:Partial<Record<string,Uint8Array>>={},version=TREE_VERSION,options:{textureMimeTypes?:Record<string,string>;doubleSided?:Record<string,boolean>;source?:string}={}):ArrayBuffer {
