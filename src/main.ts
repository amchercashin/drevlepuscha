...
try {
  ...
  const daylight=showcaseEnabled?createDaylight(scene,camera,world.sun,world.fill,air):null;
  ...
  canvas.addEventListener('pointermove',e=>{
    ...
    pitch=clamp(pitch+e.movementY*0.16,minimumPitch,config.travel.pitchMaxDeg);
  });
